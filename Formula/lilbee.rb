class Lilbee < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "d922635cadc3d00217f243f4b3f6310418449bf69c559337e0b96b6133cf1304"
    end

    on_intel do
      url "https://github.com/tobocop2/lilbee/releases/download/v#{version}/lilbee-macos-x86_64"
      sha256 "20100302a039f1dbe586e7ec06152c04bd1019dfddcacba1f1a217477b5ab6e8"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "024fd2136b18d426cfdf68aaaaaaa0384aa4e3571db11cfe5e6730a2872d2ea5"
    end
  end
